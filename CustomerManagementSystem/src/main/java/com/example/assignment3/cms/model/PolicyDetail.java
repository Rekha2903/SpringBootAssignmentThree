 ...
 * 
 */
package com.example.assignment3.cms.model;
...
public class PolicyDetail {
	...
	public String toString() {
		return "PolicyDetail [policyId=" + policyId + ", customerId=" + customerId + ", customerFname=" + customerFname
				+ ", customerLname=" + customerLname + ", policyName=" + policyName + ", premiumFrequency="
				+ premiumFrequency + ", premiumAmount=" + premiumAmount + ", maturityDate=" + maturityDate
	 ...
	 */
	public PolicyDetail(int policyId, int customerId, String customerFname, String customerLname, String policyName,
			String premiumFrequency, long premiumAmount, Date maturityDate, double maturityAmount) {
